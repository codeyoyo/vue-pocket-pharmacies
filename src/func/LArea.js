  ...
  MobileArea.prototype = {
    ...
    bindEvent: function () {
      ...
      function popupArea(e) {
        var gearDom=document.getElementById('gearParent');
        if(gearDom){
          _self.gearArea = gearDom;
        }else{
          _self.gearArea = document.createElement("div");
        }
        _self.gearArea.id="gearParent";
        _self.gearArea.className = "gearArea";
        _self.gearArea.innerHTML = '<div id="gearChild" class="area_ctrl slideInUp">' +
